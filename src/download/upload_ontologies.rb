...
ontologiesV1 = [
    {:acronym => "MTHMSTFRE",
     ...
     :description => "Traduction française de International Classification of Primary Care. Mise à dispostion par UMLS",
     :uploadPath => "#{ontologiesPath}/v1/MTHMSTFRE.ttl",
     :contact => "Vincent Emonet",
     :homepage => "http://www.nlm.nih.gov/research/umls/licensedcontent/umlsknowledgesources.html",
     :publication => "",
     :documentation => "https://github.com/ncbo/umls2rdf"},
